"""Drive graphed M0 (spine) + M2 (frontend) through the real orchestrator from local-gate evidence.

Without --ci-confirmed the milestones stop at REVIEW (the A.5-matrix gate is only green on CI).
"""
